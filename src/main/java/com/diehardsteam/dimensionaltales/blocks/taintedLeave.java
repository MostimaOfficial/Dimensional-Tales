...
public class taintedLeave extends BlockLeavesBase implements IShearable
{
	 public taintedLeave()
	    {
	        ...
	        this.setBlockTextureName("dimensionaltales:leaveTainted");
	    }
    ...
    {
        return Item.getItemFromBlock(BlockRegistry.taintedTree);
    }
